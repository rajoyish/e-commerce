                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        @php
                            $status = match($order->status) {
                                  'new' => '<span class="bg-red-500 py-1 px-3 rounded text-white shadow">new</span>',
                                  'pending' => '<span class="bg-yellow-500 py-1 px-3 rounded text-white shadow">pending</span>',
                                  'processing' => '<span class="bg-blue-500 py-1 px-3 rounded text-white shadow">processing</span>',
                                  'delivered' => '<span class="bg-green-500 py-1 px-3 rounded text-white shadow">delivered</span>',
                                  'shipped' => '<span class="bg-teal-500 py-1 px-3 rounded text-white shadow">shipped</span>',
                                  'canceled' => '<span class="bg-gray-500 py-1 px-3 rounded text-white shadow">canceled</span>',
                              };
                        @endphp
                        {!! $status !!}
                    </div>
